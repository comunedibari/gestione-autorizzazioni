...
roadsite.prototype.approve = function(opt,callback)
{
  ...
  uploadAttach(opt, function(attErr,attRes)
  {
    if (attErr)
    {
      var msg = attErr ? "Upload approved attach error: "  + attErr.message : "Upload approved attach error";
      self.log.error(self.moduleName + " - "  + msg);
      callback({message:msg},attRes);
      return;
    }
    else
    {
      ...
      var dir = self.attachment.path + "/" + self.entityName;
      var nameFile = opt.entity_id + "_" + file.originalname;
      ...
      self.httpClient.post(reqOpt,JSON.stringify(reqBody),function(resE)
      {
        ...
        object.approved_attach = file.originalname;
        ...
        roadsite.super_.prototype.update.call(self, updOpt, function(uErr, uRes)
        {
          ...
          */
          ...
          var mailPecOpt =
          {
            ...
            subject: subjectMail,
            text: textMail,
            attachments: [{filename:file.originalname, path:fileToSend}]
          };
